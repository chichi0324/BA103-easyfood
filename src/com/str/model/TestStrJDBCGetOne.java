...
//		System.out.println(vo.getStr_lat());
	...
	public static void readPicture(byte[] bytes,String str_no) throws IOException {
		
		FileOutputStream out = null;
		if(bytes.length != 0) {
			out = new FileOutputStream("C:\\Users\\user\\Desktop\\Jenny_WebApp\\eclipse-neno3-workspace\\BA103G3_blog\\WebContent\\easyfood\\storeIMG\\"+ str_no + ".jpg");
			out.write(bytes);
			out.flush();
		}
	...
	public static void readFile(String str) throws IOException {
		...
		if(str.length() != 0) {
			out = new PrintWriter("info/" + TestStrJDBCGetOne.strName + ".txt");
			out.write(str);
			out.flush();
		}
