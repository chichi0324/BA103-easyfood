...
<%@ page import="java.util.*, com.rep.model.*,com.ord.model.*,com.mem.model.*"%>
<%
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/easyfood/front-end/class/member/css/evaluate.css">
<style type="text/css">
</style>
</head>
<body>
				...
				<div class="panel panel-default">
					...
					<ul class="list-group">
						<li class="list-group-item">
							<form METHOD="post" ACTION="<%=request.getContextPath()%>/easyfood/front-end/class/member/Ord.do">
								<div class="form-group">
									...
									<div class="row lead">
										...
										<span id="count">0</span> star(s) <input type="hidden"
											name="ord_ev" id="inputValue" value="">
									</div>
									<textarea class="form-control" name="ord_eva" rows="5"
										id="comment"><%
											if (ordVO != null) {
										%><%=ordVO.getOrd_eva()%><%
											}
								...
								<div class="text-right">
									...
									<button type="submit" class="btn btn-success"
										data-toggle="modal" data-target="#myModal">送出評價</button>
									<%
										} else {
									%>
									<button type="submit" class="btn btn-success"
										data-toggle="modal" data-target="#myModal">修改評價</button>
									<%
										}
									%>
									<input type="hidden" name="ord_no" value="<%=ord_no%>">
									<input type="hidden" name="action" value="addOrModifyEv">
									</form>
									<!-- Modal -->
    ...
    <jsp:include page="/easyfood/front-end/footer.jsp" flush="true" />
		...
		<script language="JavaScript" src="<%=request.getContextPath()%>/easyfood/front-end/class/member/js/evaluate.js"></script>
