		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
				<div class="list-group">
					...
					<a href="<%=request.getContextPath()%>/easyfood/front-end/class/store/str_inform01.jsp" class="list-group-item">評價通知</a>
					<a href="<%=request.getContextPath()%>/easyfood/front-end/class/store/str_inform02.jsp" class="list-group-item list-group-item-info">檢舉通知</a>
				</div>
			</div>
