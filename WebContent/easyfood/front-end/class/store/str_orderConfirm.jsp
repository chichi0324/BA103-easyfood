...
<%
	...
	List<OrdVO> list = ordSvc.getStatus(str_no, "已確認");
	pageContext.setAttribute("ordList", list);
	int count = 0;
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-3">
			<div class="list-group">
				...
				<a href="<%=request.getContextPath()%>/easyfood/front-end/class/store/str_orderView.jsp" class="list-group-item">訂單總覽</a>
				<a href="<%=request.getContextPath()%>/easyfood/front-end/class/store/str_orderCheck.jsp" class="list-group-item">未確認訂單</a>
				<a href="<%=request.getContextPath()%>/easyfood/front-end/class/store/str_orderConfirm.jsp" class="list-group-item list-group-item-info">已確認訂單</a>
			</div>
		</div>

		<!-- 右邊開始 =======================================-->			
		<div class="col-xs-12 col-sm-9">
			<div class="page-header order-page">已確認訂單</div>
