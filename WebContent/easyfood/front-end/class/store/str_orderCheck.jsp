...
<%
	...
	List<OrdVO> list = ordSvc.getStatus(str_no, "未確認");
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-3">
			<div class="list-group">
				...
				<a href="<%=request.getContextPath()%>/easyfood/front-end/class/store/str_orderCheck.jsp" class="list-group-item list-group-item-info">未確認訂單</a>
		...
		<div class="col-xs-12 col-sm-9">
			<div class="page-header order-page">未確認訂單</div>
