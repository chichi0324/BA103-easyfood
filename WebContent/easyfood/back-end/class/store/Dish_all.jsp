...
<%
	...
	pageContext.setAttribute("dishList", list);
	...
	<div class="container-floid">
		<div class="row">
			<div class="col-xs-12">
				...
				<table class="table">
					 <tr align="center">
						<th style="border-top-left-radius:5px;border-bottom-left-radius:5px;">菜單編號</th>
						<th>菜單名稱</th>
						<th>菜單價格</th>
						<th>餐點類型</th>
						<th>餐點狀態</th>
						<th>店家名稱</th>
						<th style="border-top-right-radius:5px;border-bottom-right-radius:5px;">修改內容</th>
					 </tr>
				 
			 		<%@ include file="page1.file" %>
				 	<c:forEach var="dishVO" items="${dishList}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
						<tr align="left">
